...
export default class ApiRecipe extends Component {
  ...
  componentWillMount(){
    ...
    this.props.actions.isApiFave(this.props.user.id, 'http://www.edamam.com/ontologies/edamam.owl#'+ this.props.match.params.uri)
  }
          ...
          <Flexbox style={styles.nutrition}>
              <div style={styles.commentHeader}>
                ...
                <Paper style={styles.ingredientsPaper} zDepth={3}>
                  ...
                  <a href={this.props.edamamfocus.url} target="_blank"><RaisedButton label="CREATE THIS RECIPE" fullWidth={true} /></a>

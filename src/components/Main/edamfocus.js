...
export default class Edamam extends Component {
  ...
  render() {
    ...
    //array for Tags
    let tagsarr = [];
    let arr = this.props.recipeFocus.healthLabels
    console.log(arr);
    //
      ...
      <div>
          ...
          <Card style={divStyle}>
            <CardMedia overlay={<CardTitle title={this.props.data.title} subtitle={this.props.data.description} />}>
              <img src={'https://s3.amazonaws.com/vcbc/recipes/'+this.props.data.image} alt="" />
            </CardMedia>
            <CardText>
